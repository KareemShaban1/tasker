...
export default {
  ...
  computed: { ...mapGetters('Language', ['isLoading', 'filterItems']) },

  methods: {
    ...mapActions('Language', ['fetchAllLanguages']),
    ...mapMutations('Language', ['setIsLoading', 'setHasFilter', 'setFilterItems']),

    getResults() {
      this.query.page = 1
      this.fetchAllLanguages(this.query)
    ...
    async clearFilter() {
      try {
        ...
        await this.fetchAllLanguages(this.query)
