...
export default {
  ...
  computed: { ...mapGetters('Country', ['isLoading', 'filterItems']) },

  methods: {
    ...mapActions('Country', ['fetchAllCountries']),
    ...mapMutations('Country', ['setIsLoading', 'setHasFilter', 'setFilterItems']),

    getResults() {
      this.query.page = 1
      this.fetchAllCountries(this.query)
    ...
    async clearFilter() {
      try {
        ...
        await this.fetchAllCountries(this.query)
