...
export default {
  ...
  computed: { ...mapGetters('State', ['isLoading', 'filterItems']) },

  methods: {
    ...mapActions('State', ['fetchAllStates']),
    ...mapMutations('State', ['setIsLoading', 'setHasFilter', 'setFilterItems']),

    getResults() {
      this.query.page = 1
      this.fetchAllStates(this.query)
    ...
    async clearFilter() {
      try {
        ...
        await this.fetchAllStates(this.query)
